      ...
      var l = (function () {
        ...
        return (
          i(e, [{
            ...
            value: function () {
              var e = this;
              this.player.template.list.addEventListener("click", function (
                t
              ) {
                var n = void 0;
                n =
          ...
          },
          {
            ...
            value: function (e) {
              ...
              (this.player.template.listOl.innerHTML += (0, a.default)({
                ...
                (this.player.template.listCurs = this.player.container.querySelectorAll(
                  ".aplayer-list-cur"
                )),
              ...
              if (
                ...
                n && n.classList.remove("aplayer-list-light"),
                  this.player.container
                    .querySelectorAll(".aplayer-list li")[this.index].classList.add("aplayer-list-light"),
                  (0, o.default)(
                    33 * this.index,
                    500,
                    null,
                  ...
                  (this.player.template.dtime.innerHTML = r.default.secondToTime(
                  ...
                  "one" === e.player.options.loop ?
                    ...
                    "none" === e.player.options.loop ?
                      ...
                      ((e.player.options.loop = "one"),
                        (e.player.template.loop.innerHTML = r.default.loopOne)) :
                  "one" === e.player.options.loop ||
                    "all" === e.player.options.loop ?
                    ((e.player.options.loop = "none"),
                      (e.player.template.loop.innerHTML = r.default.loopNone)) :
          ...
          i(e, [{
            ...
            value: function () {
              ...
              this.options.audio.length &&
                ...
                (this.listOl = this.container.querySelector(
                  ".aplayer-list ol"
                )),
                (this.listCurs = this.container.querySelectorAll(
                  ".aplayer-list-cur"
                )),
                (this.played = this.container.querySelector(
                  ".aplayer-played"
                )),
                (this.loaded = this.container.querySelector(
                  ".aplayer-loaded"
                )),
                ...
                (this.author = this.container.querySelector(
                  ".aplayer-author"
                )),
                ...
                (this.lrcButton = this.container.querySelector(
                  ".aplayer-icon-lrc"
                ));
            }
          }]),
      ...
      (function (e, t) {
        !(function (e, n) {
          ...
          (d.setImmediate = function (e) {
            ...
            for (
              var t = new Array(arguments.length - 1), n = 0; n < t.length; n++
            )
              t[n] = arguments[n + 1];
          ...
          },
          {
            ...
            value: function (e) {
              (e = Math.max(e, 0)),
                ...
                (this.template.ptime.innerHTML = r.default.secondToTime(
                  e
                ));
            }
          },
